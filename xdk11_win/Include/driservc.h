...
*/
	...
	STDMETHOD(GetMemberIndex) (THIS_
		MoaDrMemberIndex FAR * pMemberIndex)  /* Pointer to position of cast member in cast */
		PURE;
...
*/
	...
	STDMETHOD(CallHandler)(THIS_
		...
		MoaBool FAR * pHandled)  /* Pointer to a MoaBool to receive TRUE if the handler exists in the script (message handled), or FALSE if it does not.*/
		PURE;
...
*/
	...
	STDMETHOD(GetIndexInMovie)(THIS_
		struct IMoaDrMovie FAR * pIMoaDirMovie,  /* Pointer to a caller-owned interface for the movie of interest. */
		MoaDrCastIndex	FAR * pCastIndex)  /* Pointer to a MoaDrCastIndex to receive the index of the cast in the specified movie */
		PURE;
...
*/
	...
	STDMETHOD(GetFirstUsedMemberIndex)(THIS_
		MoaDrMemberIndex FAR * pMemberIndex)  /* Pointer to a MoaDrMemberIndex to receive the memberIndex. */
		PURE;
...
*/
	...
	STDMETHOD(GetNextUsedMemberIndex)(THIS_
		...
		MoaDrMemberIndex FAR * pMemberIndex)  /* Pointer to a MoaDrMemberIndex to receive the member index */
		PURE;
...
*/
	...
	STDMETHOD(GetMemberIndexFromName)(THIS_
		...
		MoaDrMemberIndex FAR * pMemberIndex)  /* Pointer to a MoaDrMemberIndex to receive the index of the cast member */
		PURE;
...
*/
	...
	STDMETHOD(GetCastMem)(THIS_
		...
		PIMoaDrCastMem FAR * ppIMoaDrCastMem)  /* Pointer to a PIMoaDrCastMem to receive a pointer to the cast member's interface.  Interface is then
...
*/
	...
	STDMETHOD(DuplicateCastMem)(THIS_
		...
		struct IMoaDrCast FAR * pDestCast,	/* Pointer to a caller-owned IMoaDrCast interface for the destination cast */
...
*/
	...
	STDMETHOD(GetCastCount)(THIS_
		MoaLong FAR * pCastCount)  /* Pointer to a MoaLong to receive the number of casts */
		PURE;
...
*/
	...
	STDMETHOD(GetNthCast)(THIS_
		...
		PIMoaDrCast FAR * ppIMoaDrCast)  /* Pointer to a PIMoaDrCast to receive a pointer to the cast interface */
		PURE;
...
*/
	...
	STDMETHOD(GetCastIndexFromName)(THIS_
		PMoaChar pCastName,  /* Pointer to a null-terminated C string containing the cast name of interest */
		MoaDrCastIndex FAR * pCastIndex)  /* Pointer to a MoaDrCastIndex to receive the index */
		PURE;
...
*/
	...
	STDMETHOD(GetCastMemFromCMRef)(THIS_
		...
		PIMoaDrCastMem FAR * ppIMoaDrCastMem)  /* Pointer to a PIMoaDrCastMem to receive the interface for the cast member */
		PURE;
...
*/
	...
	STDMETHOD(UpdateStageRect) (THIS_
		MoaRect FAR * pWindowRect,	/* Pointer to a MoaRect describing the area of the stage window to update */
		MoaRect FAR * pBufferRect)	/* Pointer to a MoaRect describing the area of the offscreen buffer from where to update */
		PURE;
...
*/
	...
	STDMETHOD(GetStageWindowGC)(THIS_
		PIMoaMmGC FAR * ppWindowGC)  /* Pointer to a IMoaMmGC interface for the stage window */
		PURE;
...
*/
	...
	STDMETHOD(GetStageBufferGC)(THIS_
		PIMoaMmGC FAR * ppBufferGC)  /* Pointer to a IMoaMmGC interface for the stage offscreen buffer */
		PURE;
...
*/
	...
	STDMETHOD(SendSpriteMessage)(THIS_
		...
		MoaBool FAR * pHandled)  /* arguments to a MoaBool to receive
...
*/
	...
	STDMETHOD(GetActiveMovie)(THIS_
		PIMoaDrMovie FAR * ppIMoaDrMovie)  /* Pointer to a PIMoaDrMovie to receive new interface */
		PURE;
...
*/
	...
	STDMETHOD(GetMovieCount)(THIS_
		MoaLong FAR * pMovieCount) /* Pointer to a MoaLong to receive count of open movies */
		PURE;
...
*/
	...
	STDMETHOD(GetCastMemTypeCount)(THIS_
		MoaLong FAR * pTypeCount)  /* Pointer to a MoaLong to receive the count */
		PURE;
...

{
	...
	STDMETHOD(GetFontNumber)(THIS_
		...
		MoaLong FAR * pFontNumber,	/* Pointer to a MoaLong to receive the font number corresponding with pFontName */
